...
<a href="index.jsp"><img id="logo" src="img/REYOLABLUE.png" ></a>
    <div>
            ...
            <div>
                ...
                <table class=tb style="padding:40px;">
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <a href=#close class="closeBtn">&nbsp닫기&nbsp</a>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div id="di3" class=di style="left:950px;top:80px;font-size:3em;z-index:3;;">
            <a href=#open3>노래방</a>
        </div>
        <div class=white_content id=open3>
            <div>
                ...
                <table class=tb style="padding:40px;">
                    <tr>
                        <td>
                            <img class=im src="image/노래방.jpg" width="400px">
                        </td>
                        <td style="width:60%">아까 카페에서도 말했듯이 우린 놀 곳이 정해져 있다.
                            <br> 동네 카페 / 영화관 /
                            <b>노래방....</b>
                            <br> 특히 노래방은 저렴하고 시간도 쭉 쭉 간다 !
                            <br> 마치 자신이 가수왕인 것처럼 행복한 시간을 즐겨보자!
                            <br>
                            <a href="https://www.youtube.com/user/ziller" target="_blank">노래방 즐기기 ^_^ </a>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
	...
	<div id="piechart" style="width: 900px; height: 500px;"></div>
        ...
        <div id="di11" class=di style="left:850px; top:130px;font-size:13em; ">
            <a href=#open11>카페</a>
        </div>
        <div class=white_content id=open11>
            <div>
                ...
                <table class=tb style="padding:40px;">
                    <tr>
                        <td>
                            <img src="image/카페.jpg" width=400px>
                        </td>
                        <td style="width:60%">
                            	우린 술도 안마시고 클럽도 안가고!
                            <br> 갈 곳이 없고 달콤한 거 먹으면서 시간을 보내고 싶다면?
                            <br> 달콤하게 과제/공부하고 싶다면??
                            <br> 그래서 카페
                            <b>2위</b>!!!
                            <br>
                            <a href="https://www.diningcode.com/isearch.php?query=%EC%B9%B4%ED%8E%98" target="_blank">맛있는 카페 찾아볼까?</a>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                ...
                <table class=tb style="padding:40px;">
                    <tr>
                        ...
                        <td style="width:60%">
                            ...
                            <b>집</b>이 그립나요?
                            <br>
                            <a href="Share_Board.jsp" target="_blank">내가_집_가고싶을_때_게시판에_알려주기</a>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
...
<!--  <table class="center" width=70%>
            <tr>
             ...
             </tr>                         <tr>                             <td></td><td> <a href=#close class="closeBtn">&nbsp닫기&nbsp</a> </td>                         </tr>
